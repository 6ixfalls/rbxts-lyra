...
/**
	...
	.disableReferenceProtection boolean? -- If true, disables deep copying of data returned by `get()`. This can improve performance but requires careful handling to avoid accidentally mutating internal Store state. Defaults to `false`.
 */
export interface BaseStoreConfig<Schema> {
    ...
    // If true, disables deep copying of data returned by `get()`. This can improve performance but requires careful handling to avoid accidentally mutating internal Store state. Defaults to `false`.
